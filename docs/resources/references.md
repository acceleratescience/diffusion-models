Here you can find the relevant references used in the sections, and some additional resources. The examples here are for a course in packaging and testing Python code.
Your titles should match the page sections, and the links should be to the official documentation or other reputable sources.
